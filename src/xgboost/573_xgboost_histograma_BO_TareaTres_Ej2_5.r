...
# apagar la maquina virtual cuando termine el proceso
...
dir.create( "./exp/HT5730/", showWarnings = FALSE )
setwd( "./exp/HT5730/" )   #Establezco el Working Directory DEL EXPERIMENTO
