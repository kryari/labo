...
param  <- list( "num.trees"=       1783,  #cantidad de arboles
                "mtry"=             18,  #cantidad de variables que evalua para hacer un split  sqrt(ncol(dtrain))
                "min.node.size"=  366,  #tamaño minimo de las hojas
...
archivo_salida  <- "./labo/exp/KA2411/KA_411_TareaHogar2_Ej5_1_1.csv"
