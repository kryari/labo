...
archivo_salida  <- "./labo/exp/HT2020/gridsearch_4.txt"
...
for( vmax_depth  in  c( 5, 7, 9, 15, 17, 19)  )
{
  for( vmin_bucket  in  c(5, 10, 20, 40, 100, 150, 200, 300, 400, 600)  )
  {
  for( vmin_split  in  c(3000, 2000, 1200, 1000, 800, 600, 400, 200, 100, 50, 20)  )
{
