...
archivo_salida  <- "./labo/exp/HT2020/gridsearch_3.txt"
...
{
  for( vmin_bucket  in  c(6, 22, 160, 250, 270, 290, 300, 310, 330, 350)  )
  {
  for( vmin_split  in  c(1200, 1000, 800, 600, 200, 100, 50, 20)  )
{
...
print(delta2_sec/60/60) #imprimo
