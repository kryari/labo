...
modelo  <- rpart("clase_ternaria ~ .",  #quiero predecir clase_ternaria a partir de el resto de las variables
                 data = dtrain,
                 xval=0,
                 cp=        -0.661555299034037,   #esto significa no limitar la complejidad de los splits
                 minsplit=  2042,     #minima cantidad de registros para que se haga el split
                 minbucket=  1018,     #tamaño minimo de una hoja
...
fwrite( entrega, 
        file= "./labo/exp/KA2001/K101_TareaDos_5_3_2.csv", 
        sep= "," )
