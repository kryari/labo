...
modelo  <- lgb.train( data= dtrain,
                      param= list( objective=        "binary",
                                   ...
                                   max_bin=31,
                                   num_iterations=     350,
                                   learning_rate=0.0214920391241498,
                                   feature_fraction=  0.361591671868925,
                                   min_data_in_leaf= 3024,
                                   num_leaves=         365
)
                    )
...
entrega  <- as.data.table( list( "numero_de_cliente"= dapply[  , numero_de_cliente],
                                 "Predicted"= as.integer(prediccion > 0.0158753248040763 ) )  ) #genero la salida

dir.create( "./labo/exp/",  showWarnings = FALSE ) 
dir.create( "./labo/exp/KA2512/", showWarnings = FALSE )
archivo_salida  <- "./labo/exp/KA2512/KA_512_001_TareaTres_Ej3_base_ok.csv"
...
archivo_importancia  <- "./labo/exp/KA2512/512_importancia_001_TareaTres_Ej3_base_ok.txt"
